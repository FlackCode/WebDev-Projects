    ...
    <div className="text-white">
      <div className="md:px-48 xsm:px-4 py-6 flex items-center justify-between bg-black">
        ...
        <div className='flex flex-row gap-4 items-center'>
            ...
            <Link to={'/register'} className="md:px-6 xsm:px-4 md:py-2 xsm:py-1 bg-blue-500 rounded-full font-semibold transition-all duration-300 hover:scale-105 hover:bg-blue-600">
                Register
            </Link>
        </div>
      </div>
